...
class CreateParsedCompanyParserTaskTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('parsed_company_parser_task', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('parsed_company_id');
    ...
    {
        Schema::dropIfExists('parsed_company_task');
    }
}
